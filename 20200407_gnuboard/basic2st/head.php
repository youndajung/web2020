...
<div style="height: 400px;background:#f00">222ddd</div>
...
<style>
    ...
    .subTopBg_01{background-color:pink;} /* 서브상단백그라운드이미지 */
    .subTopBg_02{background-color:pink;}
    .subTopBg_03{background-color:blue;}
    .subTopBg_04{background-color:blue;}
